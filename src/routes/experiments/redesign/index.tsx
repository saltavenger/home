...
function RedesignPage() {
  return (
    <main className={styles.container}>
      ...
      <h3>Claude design</h3>
      <p>At Chewy, I mostly used Cursor. So, while I'm not necessarily new to AI tools, I am fairly new to Claude. I wanted to try out Claude design to help me with my dated site.</p>
