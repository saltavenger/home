      ...
      <div className={styles.content}>
        <aside className={styles.side}>
          ...
          <CardList>
            ...
            <Card compact>
              <div><a href="https://youtu.be/0XIGQRDDwsc?si=66DDt-4I6ii5-jsR" target="_blank" rel="noopener noreferrer">Dodo</a><span className={styles.meta}>3D, Maya</span></div>
            </Card>
            <Card compact>
              <div><a href="https://youtu.be/I_pGkWGe6GI?si=8BmkeNYAnayC88eJ" target="_blank" rel="noopener noreferrer">Casual Monster</a><span className={styles.meta}>Rotoscope</span></div>
            </Card>
          </CardList>
        </aside>
        <main className={styles.main}>
          ...
          <CardList>
            <Card compact>
              ...
              <span className={styles.meta}>Chewy, 2021</span>
            </Card>
            <Card compact>
              <div>
              ...
              <span className={styles.meta}>Oberon Theater — acrobatic performance, 2016</span>
            </Card>
            <Card compact>
              <div><strong>Accessibility &amp; semantic design: creating clean and accessible code</strong></div>
              <span className={styles.meta}>Boston CSS Meetup, 2015</span>
            </Card>
            <Card compact>
              <div><strong>2nd place — Hackfit</strong></div>
              <span className={styles.meta}>Routine building application for outpatient recovery from addiction, 2014</span>
            </Card>
          </CardList>
